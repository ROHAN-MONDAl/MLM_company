...
<div class="sidebar-nav">
    ...
    <div class="sidebar-menu">
        <ul class="nav flex-column w-100">
            ...
            <!-- Dropdown: Inventory -->
            <li>
                <a class="nav-link dropdown-toggle <?= in_array($current_page, ['add_products.php', 'products.php']) ? '' : 'collapsed' ?>"
                    data-bs-toggle="collapse" href="#InventoryMenu" role="button"
                    aria-expanded="<?= in_array($current_page, ['add_products.php', 'products.php']) ? 'true' : 'false' ?>"
                    aria-controls="InventoryMenu">
                    <i class="fas fa-boxes"></i>
                    <span class="nav-text">Inventories</span>
                    <i class="fas fa-chevron-down toggle-icon mx-auto"></i>
                </a>
                <div class="collapse dropdown-animated <?= in_array($current_page, ['add_products.php', 'products.php']) ? 'show' : '' ?>"
                    id="InventoryMenu">
                    <ul class="nav flex-column">
                        <li>
                            <a href="add_products.php"
                                class="nav-link <?= ($current_page == 'add_products.php') ? 'active' : '' ?>">
                        ...
                        <li>
                            <a href="products.php"
                                class="nav-link <?= ($current_page == 'products.php') ? 'active' : '' ?>">
            ...
            <li>
                <a class="nav-link dropdown-toggle <?= in_array($current_page, ['all_distributors.php', 'distributor_groups.php']) ? '' : 'collapsed' ?>"
                    data-bs-toggle="collapse" href="#DistributorsMenu" role="button"
                    aria-expanded="<?= in_array($current_page, ['all_distributors.php', 'distributor_groups.php']) ? 'true' : 'false' ?>"
                ...
                <div class="collapse dropdown-animated <?= in_array($current_page, ['all_distributors.php', 'distributor_groups.php']) ? 'show' : '' ?>"
                    ...
                    <ul class="nav flex-column">
                        <li>
                            <a href="all_distributors.php"
                                class="nav-link <?= ($current_page == 'all_distributors.php') ? 'active' : '' ?>">
            ...
            <li>
                <a class="nav-link dropdown-toggle <?= in_array($current_page, ['settings_profile.php', 'settings_security.php']) ? '' : 'collapsed' ?>"
                    ...
                    aria-expanded="<?= in_array($current_page, ['settings_profile.php', 'settings_security.php']) ? 'true' : 'false' ?>"
                    ...
                    <ul class="nav flex-column">
                        <li>
                            <a href="settings_profile.php"
                                class="nav-link <?= ($current_page == 'settings_profile.php') ? 'active' : '' ?>">
                        ...
                        <li>
                            <a href="settings_security.php"
                                class="nav-link <?= ($current_page == 'settings_security.php') ? 'active' : '' ?>">
